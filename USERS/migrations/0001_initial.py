# Generated by Django 4.0.3 on 2023-08-09 03:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_std_error', models.TextField(default='', max_length=10000)),
                ('submission_time', models.DateTimeField(auto_now_add=True, null=True)),
                ('run_time', models.FloatField(default=0, null=True)),
                ('language', models.CharField(choices=[('Python3', 'Python3'), ('C++', 'C++'), ('Java', 'Java'), ('C', 'C')], default='C++', max_length=10)),
